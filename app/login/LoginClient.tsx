...
export default function LoginPage() {
  ...
  return (
    <main id="main-content" className="flex-1 pt-16 flex items-center justify-center min-h-screen bg-muted">
      ...
      <div className="w-full max-w-md px-4">
        <div className="bg-parchment-dark border border-sand rounded-md p-8 shadow-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label htmlFor="login-email" className="block text-sm font-medium text-bark mb-1.5">Email</label>
              <input
                id="login-email"
                type="email"
                value={email}
            ...
            <div>
              <label htmlFor="login-password" className="block text-sm font-medium text-bark mb-1.5">Password</label>
              <input
                id="login-password"
                type="password"
                value={password}
