...
export default function SignupPage() {
  ...
  return (
    <main id="main-content" className="flex-1 pt-16 flex items-center justify-center min-h-screen bg-parchment">
          ...
          {done ? (
            ...
            <>
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                <div>
                  <label htmlFor="signup-name" className="block text-sm font-medium text-bark mb-1.5">Full Name</label>
                  <input
                    id="signup-name"
                    type="text"
                    value={fullName}
                ...
                <div>
                  <label htmlFor="signup-email" className="block text-sm font-medium text-bark mb-1.5">Email</label>
                  <input
                    id="signup-email"
                    type="email"
                    value={email}
                ...
                <div>
                  <label htmlFor="signup-password" className="block text-sm font-medium text-bark mb-1.5">Password</label>
                  <input
                    id="signup-password"
                    type="password"
                    value={password}
