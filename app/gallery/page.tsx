    ...
    <main className="flex-1 pt-16">
      ...
      <section className="pb-32 pt-16 bg-parchment">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-display text-2xl text-bark font-bold mb-3">Gallery coming soon</p>
          <p className="text-soil text-base max-w-md mx-auto">We&apos;re pulling together photos from the trail. Until then, our Instagram is the best place to see what we&apos;ve been up to.</p>
          <a
